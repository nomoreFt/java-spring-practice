...
class PaginationServiceTest {
    ...
    @MethodSource
    @ParameterizedTest(name = "{index} => 현재 페이지={0}, 총페이지={1} 기대 페이지={2}")
    void givenCurrentPageNumAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(int currentPageNumber, int totalPages, List<Integer> expected){
        //given
    ...
    static Stream<Arguments> givenCurrentPageNumAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers(){
        return Stream.of(
                ...
                Arguments.arguments(7, 13, List.of(5, 6, 7, 8, 9)),
                Arguments.arguments(8, 13, List.of(6, 7, 8, 9, 10)),
