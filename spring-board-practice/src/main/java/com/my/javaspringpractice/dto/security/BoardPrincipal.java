package com.my.javaspringpractice.dto.security;
...
public record BoardPrincipal(
    ...
    public static BoardPrincipal of(UserId username, String password, String email, String nickname, String memo) {
